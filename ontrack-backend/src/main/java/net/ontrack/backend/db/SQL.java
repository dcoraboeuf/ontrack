...
public interface SQL {
    ...
    String ACCOUNT_AUTHENTICATE = "SELECT ID, NAME, FULLNAME, ROLENAME, MODE FROM ACCOUNTS WHERE MODE = 'builtin' AND NAME = :user AND PASSWORD = :password";

    String ACCOUNT_ROLE = "SELECT ROLENAME FROM ACCOUNTS WHERE MODE = :mode AND NAME = :user";

    String ACCOUNT = "SELECT ID, NAME, FULLNAME, ROLENAME, MODE FROM ACCOUNTS WHERE MODE = :mode AND NAME = :user";
