...
public interface SQL {
    ...
    String VALIDATION_STAMP_FOR_PROMOTION_LEVEL = "SELECT ID, BRANCH, NAME, DESCRIPTION FROM VALIDATION_STAMP WHERE PROMOTION_LEVEL = :promotionLevel ORDER BY NAME";

    String VALIDATION_STAMP_WITHOUT_PROMOTION_LEVEL = "SELECT ID, BRANCH, NAME, DESCRIPTION FROM VALIDATION_STAMP WHERE BRANCH = :branch AND PROMOTION_LEVEL IS NULL ORDER BY NAME";
    ...
    String EVENT_DATED_SIGNATURE = "SELECT AUTHOR, AUTHOR_ID, EVENT_TIMESTAMP FROM EVENTS WHERE EVENT_TYPE = :eventType AND %s = :entityId ORDER BY ID DESC LIMIT 1";
