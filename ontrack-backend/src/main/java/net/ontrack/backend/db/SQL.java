...
public interface SQL {
	...
	String VALIDATION_RUN = "SELECT * FROM VALIDATION_RUN WHERE ID = :id";
    ...
    String VALIDATION_RUN_STATUS_LAST_FOR_BUILD = "SELECT RS.* FROM VALIDATION_RUN_STATUS RS, VALIDATION_RUN R WHERE RS.RUN = R.ID AND R.BUILD = :build AND R.VALIDATION_STAMP = :validationStamp ORDER BY RS.ID DESC LIMIT 1";
