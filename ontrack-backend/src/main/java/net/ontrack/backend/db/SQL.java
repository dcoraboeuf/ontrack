...
public interface SQL {
    ...
    String PROMOTED_RUN_CREATE = "INSERT INTO PROMOTED_RUN (PROMOTION_LEVEL, BUILD, CREATION, DESCRIPTION) VALUES (:promotionLevel, :build, :creation, :description)";

    String PROMOTED_RUN = "SELECT ID, PROMOTION_LEVEL, BUILD, CREATION, DESCRIPTION FROM PROMOTED_RUN WHERE BUILD = :build AND PROMOTION_LEVEL = :promotionLevel";
