...
public class DefaultProfileService implements ProfileService {
    ...
    @Autowired
    public DefaultProfileService(SecurityUtils securityUtils, ManagementService managementService, ValidationStampDao validationStampDao, ValidationStampSelectionDao validationStampSelectionDao) {
