...
UPDATE PROMOTED_RUN PR SET AUTHOR_ID = (SELECT E.AUTHOR_ID  FROM EVENTS E WHERE E.EVENT_TYPE  = 'BUILD_CREATED' AND E.BUILD = PR.BUILD);
UPDATE PROMOTED_RUN PR SET AUTHOR = (SELECT E.AUTHOR  FROM EVENTS E WHERE E.EVENT_TYPE  = 'BUILD_CREATED' AND E.BUILD = PR.BUILD);
